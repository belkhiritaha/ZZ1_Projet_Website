    ...
    if (!open) {
      return (
          <>
              ...
              <Button style={{ width: "20vw", marginLeft: "40vw", marginTop: "10vh" }} variant="success" size="lg" block onClick={() => setOpen(!open)} aria-controls="example-collapse-text" aria-expanded={open}>
